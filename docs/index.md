   ...
   <TBODY><TR align=middle>
    ...
    <TD width="71%" align=middle vAlign=top>
      <TABLE cellSpacing=0 cellPadding=0 width="97%" border=0>
        <TBODY>
        <TR>
          <TD height="242" align=left ><div align="center"> 
<p><strong>Организация праздников. Настоящее событие трудно представить без ярких моментов, которые, в будущем будут порождать тёплые воспоминания и обогревать душу. Безупречные специалисты и грандиозный поток идей  агентства "АПЕЛЬСИН" станут вашими верными помощниками в реализации ваших особенных мероприятий.</strong><br />
  <strong>Во-первых,</strong>  9-летний опыт работы на рынке ивент-услуг. <br />
  <strong>Во-вторых,</strong> 2 в 1: проведение на высоком уровне как душевных семейных мероприятий, так и бизнес-событий. <br />
  <strong>В-третьих,</strong>  Креативное мышление наших сотрудников (мы предлагаем всегда яркие и оригинальные идеи);. <br />
 <strong>В-четвертых,</strong> Выполнение заказов "под ключ"  </p>   </div>            
            </TD></TR>
        </TBODY></TABLE></TD>
    <TD vAlign=top width="14%" >
